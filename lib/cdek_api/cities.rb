...
module CdekApi
  ...
  module Cities
    ...
    CODES = {
      ...
      # СНТ Щербаков хутор массив Щербаков хутор
      '47-18-0-700' => {
